...
const BASE_TASKS_BY_DAY = {
  ...
  14: [
    { id: "t18", text: "🎬 15강. 컴포넌트의 Props (10분)", tagId: "tag-lecture" },
    { id: "t19", text: "🎬 16강. 이벤트 핸들링 (8분)", tagId: "tag-lecture" },
    { id: "t20", text: "✏️ Props로 버튼 컴포넌트 만들기", tagId: "tag-practice" },
    { id: "t21", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  15: [
    { id: "t22", text: "🎬 17강. State 기초 (12분)", tagId: "tag-lecture" },
    { id: "t23", text: "🎬 18강. State 더 깊이 알기 (14분)", tagId: "tag-lecture" },
    { id: "t24", text: "✏️ 카운터 앱 혼자 만들기 (AI 없이!)", tagId: "tag-practice" },
    { id: "t25", text: "🔁 coupang — TypeORM Entity 읽기", tagId: "tag-nestjs" },
    { id: "t26", text: "📌 1주차 정리", tagId: "tag-quiz" },
    { id: "t27", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  // ── 2주차: 3/16(월) ~ 3/22(일) ──
  16: [
    { id: "t28", text: "🎬 19강. useReducer (14분)", tagId: "tag-lecture" },
    { id: "t29", text: "✏️ useState → useReducer 리팩토링", tagId: "tag-practice" },
    { id: "t30", text: "🔁 coupang — 상품 CRUD API 코드 읽기", tagId: "tag-nestjs" },
    { id: "t31", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  17: [
    { id: "t32", text: "🎬 20강. useRef (10분)", tagId: "tag-lecture" },
    { id: "t33", text: "🎬 21강. 생명주기와 useEffect (17분)", tagId: "tag-lecture" },
    { id: "t34", text: "✏️ useEffect로 타이머 만들기", tagId: "tag-practice" },
    { id: "t35", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  18: [
    { id: "t36", text: "🎬 22강. 커스텀 훅 (9분)", tagId: "tag-lecture" },
    { id: "t37", text: "✏️ useFetch 커스텀 훅 만들기", tagId: "tag-practice" },
    { id: "t38", text: "🔁 kurly — coupang과 구조 차이 비교", tagId: "tag-nestjs" },
    { id: "t39", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  19: [
    { id: "t40", text: "🎬 23강. 최적화 (7분)", tagId: "tag-lecture" },
    { id: "t41", text: "✏️ useMemo / useCallback 정리", tagId: "tag-practice" },
    { id: "t42", text: "🔁 NestJS — Pipe, ValidationPipe 정리", tagId: "tag-nestjs" },
    { id: "t43", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  20: [
    { id: "t44", text: "🎬 25강. Context (8분)", tagId: "tag-lecture" },
    { id: "t45", text: "✏️ Context로 다크모드 토글 만들기", tagId: "tag-practice" },
    { id: "t46", text: "🔁 coupang — JWT 인증 흐름 정리", tagId: "tag-nestjs" },
    { id: "t47", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  21: [
    { id: "t48", text: "🎬 26강. 라우팅 (10분)", tagId: "tag-lecture" },
    { id: "t49", text: "🎬 27강. 리액트 19 추가기능 (8분)", tagId: "tag-lecture" },
    { id: "t50", text: "✏️ 페이지 이동 실습 (홈·상세·404)", tagId: "tag-practice" },
    { id: "t51", text: "📝 섹션3 퀴즈 풀기", tagId: "tag-quiz" },
    { id: "t52", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  22: [
    { id: "t53", text: "🎬 28강. 파이널 프로젝트 세팅 (6분)", tagId: "tag-lecture" },
    { id: "t54", text: "🎬 29강. 컨텍스트·라우팅 설계 (9분)", tagId: "tag-lecture" },
    { id: "t55", text: "🎬 30강. 페이지·컴포넌트 작성 (13분)", tagId: "tag-lecture" },
    { id: "t56", text: "🎉 완강! 혼자 설명 가능한 개념 목록", tagId: "tag-quiz" },
    { id: "t57", text: "📝 섹션4 퀴즈 풀기", tagId: "tag-quiz" },
    { id: "t58", text: "📌 2주차 회고 + NestJS 복습 정리", tagId: "tag-quiz" },
    { id: "t59", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  // ── 3주차: 3/23(월) ~ 3/29(일) — 혼자 만들기 + coupang 연결 ──
  23: [
    { id: "t60", text: "✏️ 프로젝트 주제 확정 & 구조 설계", tagId: "tag-practice" },
    { id: "t61", text: "✏️ Vite로 React 프로젝트 생성", tagId: "tag-practice" },
    { id: "t62", text: "✏️ Header, Footer, 레이아웃 컴포넌트", tagId: "tag-practice" },
    { id: "t63", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  24: [
    { id: "t64", text: "✏️ React Router 라우팅 구조 잡기", tagId: "tag-practice" },
    { id: "t65", text: "✏️ 핵심 기능 1 구현 (목록 조회/검색)", tagId: "tag-practice" },
    { id: "t66", text: "⚠️ 막히면 구글 → 공식문서 (AI X)", tagId: "tag-practice" },
    { id: "t67", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  25: [
    { id: "t68", text: "✏️ 핵심 기능 2 구현 (상세/추가/삭제)", tagId: "tag-practice" },
    { id: "t69", text: "📌 GitHub 중간 커밋 push", tagId: "tag-quiz" },
    { id: "t70", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  26: [
    { id: "t71", text: "✏️ coupang NestJS API 로컬 실행", tagId: "tag-practice" },
    { id: "t72", text: "✏️ React에서 coupang API fetch 연결", tagId: "tag-practice" },
    { id: "t73", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  27: [
    { id: "t74", text: "✏️ CORS 이슈 해결 (NestJS cors 설정)", tagId: "tag-practice" },
    { id: "t75", text: "✏️ 상품 목록 API → React 화면 출력", tagId: "tag-practice" },
    { id: "t76", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  28: [
    { id: "t77", text: "✏️ 로그인 폼 + JWT 연결 시도", tagId: "tag-practice" },
    { id: "t78", text: "🔍 에러 메시지 검색해서 직접 해결", tagId: "tag-practice" },
    { id: "t79", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  29: [
    { id: "t80", text: "✏️ 연결 기능 마무리 & 버그 수정", tagId: "tag-practice" },
    { id: "t81", text: "📌 README.md 업데이트 (스크린샷 포함)", tagId: "tag-quiz" },
    { id: "t82", text: "📌 GitHub push 완료", tagId: "tag-quiz" },
    { id: "t83", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  // ── 마무리: 3/30(월) ~ 3/31(화) ──
  30: [
    { id: "t84", text: "📝 3월 회고 작성", tagId: "tag-quiz" },
    { id: "t85", text: "🐍 백준 Python 1문제", tagId: "tag-algo" },
  ],
  31: [
    { id: "t86", text: "📋 4월 계획 확인", tagId: "tag-quiz" },
    { id: "t87", text: "📌 오늘의 코드 커밋으로 3월 마무리 ✨", tagId: "tag-quiz" },
...
const WEEKS_META = [
  { id: "week1", label: "1주차", range: "3/10(화) ~ 3/15(일)", theme: "⚡ 섹션1·2 + Props·State 따라잡기", themeDesc: "환경세팅, JSX, 컴포넌트, Props, State 기초 / Python 입문", color: "#ec4899", lightColor: "#fdf2f8", days: [10, 11, 12, 13, 14, 15] },
  { id: "week2", label: "2주차", range: "3/16(월) ~ 3/22(일)", theme: "🧩 훅 완성 + 완강!", themeDesc: "useReducer, useRef, useEffect, 커스텀훅, Context, Router / 완강 🎉", color: "#0ea5e9", lightColor: "#f0f9ff", days: [16, 17, 18, 19, 20, 21, 22] },
  { id: "week3", label: "3주차", range: "3/23(월) ~ 3/29(일)", theme: "🚀 혼자 만들기 + coupang 연결", themeDesc: "강의 없이 혼자 프로젝트 → React + NestJS 풀스택", color: "#10b981", lightColor: "#f0fdf4", days: [23, 24, 25, 26, 27, 28, 29] },
  { id: "week4", label: "마무리", range: "3/30(월) ~ 3/31(화)", theme: "📝 회고 + 4월 준비", themeDesc: "3월 전체 회고 + 4월 계획 확인", color: "#f59e0b", lightColor: "#fffbeb", days: [30, 31] },
];
