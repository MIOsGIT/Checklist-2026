  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", paddingBottom: 48 }}>
        ...
        {/* HEADER */}
        <div style={{ background: "linear-gradient(135deg, #f47299ff 0%, #db2745ff 100%)", padding: "28px 20px 22px", color: "white", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 4px 24px rgba(219,39,119,0.3)" }}>
